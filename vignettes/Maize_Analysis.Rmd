...
ggplot2::ggsave(figure2, filename = "vignettes/figures/Figure_2.png", width = 17.25, height = 11.5, dpi = 600)
...
figure3 <-
  ...
  dplyr::arrange(date) %>%
  dplyr::mutate(labels = str_replace(Site_name, " \\s*\\([^\\)]+\\)", "")) %>%
  ggplot(aes(x = date, y = Latitude)) +
