...
# Using rayshader package to show all maize samples and the modern GDD.
mtplot <-
  MDB_min_rayshader %>%
  dplyr::mutate(Province = as.factor(Province)) %>%
  dplyr::arrange(Date) %>%
