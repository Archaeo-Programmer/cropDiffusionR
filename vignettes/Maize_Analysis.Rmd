...
# Plot the maps for when there is only 1 site (so no segments).
...
# Plot ones that have segments (i.e., more than 2 sites). 
...
maize_through_time_gdd2 <- c(maize_through_time_gdd2_1, maize_through_time_gdd2_2)

invisible(
  mapply(
    ggsave,
    file = paste0(
      "/Users/andrew/Dropbox/WSU/SKOPEII/model/Paper 2/animation2/",
      purrr::map_chr(
...
#Gif animation
# list file names and read in
imgs2 <- list.files("/Users/andrew/Dropbox/WSU/SKOPEII/model/Paper 2/animation2/", full.names = TRUE)
...
magick::image_write(image = img_animated2,
            path = "/Users/andrew/Dropbox/WSU/SKOPEII/model/Paper 2/animation2/maize_anomaly_plots_arranged_cumulative_1fps.gif")
