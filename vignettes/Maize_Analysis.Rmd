...
garb3 %>% 
  ...
  ggplot(., aes(x = delta_anom, y = delta_gdd)) +
...
# ggplot2::ggsave("vignettes/figures/GDD_temp_slopes.png", dpi = 600)
...
paleomat_extent <- ggplot2::ggplot() +
  theme_bw() +
